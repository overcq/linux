...
asmlinkage long sys_H_oux_E_fs_Q_directory_I_list_directory( unsigned, uint64_t, uint64_t __user *, uint64_t __user * );
asmlinkage long sys_H_oux_E_fs_Q_directory_I_list_file( unsigned, uint64_t, uint64_t __user *, uint64_t __user * );
...
asmlinkage long sys_H_oux_E_fs_Q_file_R_size( unsigned, uint64_t, uint64_t __user * );
...
asmlinkage long sys_H_oux_E_fs_Q_file_I_write( unsigned, uint64_t, uint64_t, uint64_t __user *, const char __user * );
