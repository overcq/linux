...
#define __NR_H_oux_E_fs_Q_device_I_sync 702
__SYSCALL(__NR_H_oux_E_fs_Q_device_I_sync, sys_H_oux_E_fs_Q_device_I_sync)
#define __NR_H_oux_E_fs_Q_directory_M 703
__SYSCALL(__NR_H_oux_E_fs_Q_directory_M, sys_H_oux_E_fs_Q_directory_M)
#define __NR_H_oux_E_fs_Q_directory_W 704
__SYSCALL(__NR_H_oux_E_fs_Q_directory_W, sys_H_oux_E_fs_Q_directory_W)
#define __NR_H_oux_E_fs_Q_file_M 705
__SYSCALL(__NR_H_oux_E_fs_Q_file_M, sys_H_oux_E_fs_Q_file_M)
#define __NR_H_oux_E_fs_Q_file_W 706
__SYSCALL(__NR_H_oux_E_fs_Q_file_W, sys_H_oux_E_fs_Q_file_W)
#define __NR_H_oux_E_fs_Q_directory_I_list_directory 707
__SYSCALL(__NR_H_oux_E_fs_Q_directory_I_list_directory, sys_H_oux_E_fs_Q_directory_I_list_directory)
#define __NR_H_oux_E_fs_Q_directory_I_list_file 708
__SYSCALL(__NR_H_oux_E_fs_Q_directory_I_list_file, sys_H_oux_E_fs_Q_directory_I_list_file)
#define __NR_H_oux_E_fs_Q_directory_R_name 709
__SYSCALL(__NR_H_oux_E_fs_Q_directory_R_name, sys_H_oux_E_fs_Q_directory_R_name)
#define __NR_H_oux_E_fs_Q_directory_P_name 710
__SYSCALL(__NR_H_oux_E_fs_Q_directory_P_name, sys_H_oux_E_fs_Q_directory_P_name)
#define __NR_H_oux_E_fs_Q_file_R_name 711
__SYSCALL(__NR_H_oux_E_fs_Q_file_R_name, sys_H_oux_E_fs_Q_file_R_name)
#define __NR_H_oux_E_fs_Q_file_P_name 712
__SYSCALL(__NR_H_oux_E_fs_Q_file_P_name, sys_H_oux_E_fs_Q_file_P_name)
#define __NR_H_oux_E_fs_Q_file_R_size 713
__SYSCALL(__NR_H_oux_E_fs_Q_file_R_size, sys_H_oux_E_fs_Q_file_R_size)
#define __NR_H_oux_E_fs_Q_directory_I_move 714
__SYSCALL(__NR_H_oux_E_fs_Q_directory_I_move, sys_H_oux_E_fs_Q_directory_I_move)
#define __NR_H_oux_E_fs_Q_file_I_move 715
__SYSCALL(__NR_H_oux_E_fs_Q_file_I_move, sys_H_oux_E_fs_Q_file_I_move)
#define __NR_H_oux_E_fs_Q_file_I_truncate 716
__SYSCALL(__NR_H_oux_E_fs_Q_file_I_truncate, sys_H_oux_E_fs_Q_file_I_truncate)
#define __NR_H_oux_E_fs_Q_file_I_lock 717
__SYSCALL(__NR_H_oux_E_fs_Q_file_I_lock, sys_H_oux_E_fs_Q_file_I_lock)
#define __NR_H_oux_E_fs_Q_file_I_read 718
__SYSCALL(__NR_H_oux_E_fs_Q_file_I_read, sys_H_oux_E_fs_Q_file_I_read)
#define __NR_H_oux_E_fs_Q_file_I_write 719
